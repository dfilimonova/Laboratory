...
<div class="add-section" onclick="toggleSection('performancelist')">
<h2>Спектакли <span class="arrow" id="arrowPerformances"></span></h2>
...
<div class="add-section" onclick="toggleSection('sessionlist')">
<h2>Сеансы <span class="arrow" id="arrowSessions"></span></h2>
...
<li>
    <a href="/views/user_details.php?user_id=<?= $user['id'] ?>">
        <?= $user['username'] ?>
    </a>
    <form action="admin_panel.php" method="post" style="display: inline;">
